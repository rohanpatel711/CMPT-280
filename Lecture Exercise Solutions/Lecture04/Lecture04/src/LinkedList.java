// *** "implements" clause added for Exercise 2 ***
...
public class LinkedList<I> implements Cursor<I> {
	...
	// *** Instance variables added for Exercise 2 ***
	...
	// *** Exercise 2: Implementation of cursor methods ***
	@Override
	...
	// *** end of methods for exercise 2 ***


	// We leave the remaining cursor methods as stubs.  Try to implement
	// these yourself.  
